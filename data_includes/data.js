...
PennController.Sequence("demographics", randomize("practice_trials"), "instructions", shuffle(randomize("critical_trials"),randomize("filler_trials")), "post_questionaire", "send", "final");
...
PennController("demographics",
               ...
               newText("intro_instructions", "<p>This experiment investigates how people process linguistic information.<p><p>Before you begin the experiment, note the following:"
                       ...
                       +"<li> Some of our questions rely on your ability to distinguish colors, so please do not participate if you are color-blind.<br>"
...
//====================================================================================================================================================================================================================
// 2. Practice trials
PennController.Template( PennController.GetTable( "simplex.csv")// change this line for the appropriate experimental list
